...
| dsh-native-macos | DeepSeek Harness 的原生 SwiftUI macOS 客户端：多个运行时版本并存、升级后对新启动的运行时跑 8 项自检并在阻断项失败时一次性回退，另有安全模式恢复与内置微信/手机远控。 | [GitHub](https://github.com/DanielW203/dsh-native-macos) |
