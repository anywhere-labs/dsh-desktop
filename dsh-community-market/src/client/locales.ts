export const zh = {
  ...
  installedBody: '这里显示当前 Profile 的直接插件依赖，包括通过其他插件市场或命令行安装的插件。可管理的插件提供升级和卸载操作。',
  install: '安装',
  uninstall: '卸载',
  upgrade: '升级',
  ...
  upgradePreviewError: '无法验证此插件的最新版本，请稍后重试。',
  alreadyLatest: '此插件已经是最新版本。',
  upgradeUnavailable: '无法确定此插件的升级来源。它可能不是通过 npm 或 GitHub 安装的。',
  currentVersion: '当前版本',
  ...
  confirmUpgradeTitle: '确认升级插件',
  confirmUpgradeBody: '将把当前 Profile 中的这个直接插件依赖升级到最新验证版本。升级前请确认插件来源与兼容性。',
  confirmInstall: '确认安装',
  ...
  disabledRestartRequired: '此插件保留了未加载状态；插件市场仍提供升级和卸载。',
  installComplete: '插件安装完成',
  uninstallComplete: '插件卸载完成',
  upgradeComplete: '插件升级完成',
...
export const en: Record<MarketLocaleKey, string> = {
  ...
  installedBody: 'Direct plugin dependencies in the active Profile appear here, including plugins installed by other markets or the CLI. Managed plugins offer upgrade and uninstall.',
  install: 'Install',
  uninstall: 'Uninstall',
  upgrade: 'Upgrade',
  ...
  upgradePreviewError: 'The latest plugin version could not be verified. Try again later.',
  alreadyLatest: 'This plugin is already at the latest version.',
  upgradeUnavailable: 'No upgrade source could be resolved for this plugin. It may not have been installed from npm or GitHub.',
  ...
  confirmUpgradeTitle: 'Confirm plugin upgrade',
  confirmUpgradeBody: 'This direct plugin dependency will be upgraded to the latest verified version in the active Profile. Review the plugin source and compatibility before upgrading.',
  ...
  disabledRestartRequired: 'This plugin retains a not-loaded state; Plugin Market still offers upgrade and uninstall.',
  installComplete: 'Plugin installed',
  uninstallComplete: 'Plugin uninstalled',
  upgradeComplete: 'Plugin upgraded',
