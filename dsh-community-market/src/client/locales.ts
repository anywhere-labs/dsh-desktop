export const zh = {
  ...
  sidebarLauncherVisibility: '在侧边栏显示插件市场',
  sidebarLauncherVisibilityBody: '关闭后仍可从“设置 > 插件”进入市场并重新开启。',
  sidebarLauncherVisibilityError: '无法保存侧边栏显示设置，请重试。',
  sourceError: '来源操作失败',
...
export const en: Record<MarketLocaleKey, string> = {
  ...
  sidebarLauncherVisibility: 'Show Plugin Market in the sidebar',
  sidebarLauncherVisibilityBody: 'When hidden, the Market remains available in Settings > Plugins so you can restore it.',
  sidebarLauncherVisibilityError: 'The sidebar visibility setting could not be saved. Please try again.',
