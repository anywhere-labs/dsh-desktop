...
import { decideApproval, decideResponsibility, getAgentSpaceSnapshot, getHumanBoard, seedAgentSpaceDemo } from './api.js';
const viewLabels = {
    all: '全部经营事件',
