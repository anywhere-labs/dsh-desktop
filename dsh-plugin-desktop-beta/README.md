...
- This project pins both the published DSH `0.1.3-alpha.2` family and the corresponding official `deepseek-harness/` release source. Product builds still resolve published package interfaces rather than linking the source checkout.
