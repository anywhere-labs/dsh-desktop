...
function NotificationOptions({
  ...
  return <div className="space-y-3" data-orientation="vertical">
    ...
    <div className="space-y-3 border-l pl-4">
      <ToggleRow checked={notifications.showResponsePreview} disabled={!notifications.enabled || (!notifications.notifyOnTurnCompletion && !notifications.notifyOnUserQuestion && !notifications.notifyOnApprovalRequest)} id="setup-response-preview" label={copy.responsePreview} onChange={checked => { set('showResponsePreview', checked) }} />
      ...
      <ToggleRow checked={notifications.notifyOnApprovalRequest} disabled={!notifications.enabled} id="setup-approval-request" label={copy.approvalRequest} onChange={checked => { set('notifyOnApprovalRequest', checked) }} />
