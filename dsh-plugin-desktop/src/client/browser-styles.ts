...
.dshDesktopBrowserPanelToolbar { display: flex; align-items: center; gap: 4px; padding: 6px 8px; border-bottom: 1px solid var(--dsw-alias-border-l1); background: var(--dsw-alias-bg-layer-2); -webkit-app-region: no-drag; }
...
.dshDesktopBrowserPanelAddress { flex: 1; min-width: 0; height: 26px; padding: 0 10px; border: 1px solid var(--dsw-alias-border-l1); border-radius: 6px; background: var(--dsw-alias-bg-base); color: var(--dsw-alias-label-primary); font: inherit; }
...
.dshDesktopBrowserPanelTab { display: inline-flex; align-items: center; gap: 6px; max-width: 200px; padding: 5px 8px; border: 1px solid transparent; border-bottom: 0; border-radius: 8px 8px 0 0; color: var(--dsw-alias-label-secondary); cursor: pointer; white-space: nowrap; }
