...
export function apply(ctx: Context, config: Config): void {
  ...
  const trayIcons = {
    ...
    darkTaskbarPath: fileURLToPath(new URL('../build/tray-icon-win-dark-taskbar.png', import.meta.url)),
    lightTaskbarPath: fileURLToPath(new URL('../build/tray-icon-win-light-taskbar.png', import.meta.url)),
  }
