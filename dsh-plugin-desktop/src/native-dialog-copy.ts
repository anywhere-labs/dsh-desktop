...
const COPY: Record<DesktopLocale, DesktopNativeCopy> = {
  en: {
    ...
    pluginRecoveryInstructions: 'Open Aera Code Terminal to update or remove the failing third-party plugin, then restart Aera Code.',
    openTerminal: 'Open Aera Code Terminal',
    restart: 'Restart Aera Code',
    dismiss: 'Dismiss',
    updateAvailableTitle: 'Aera Code Update Available',
    updateAvailableMessage: version => `Aera Code ${version} is available.`,
    downloadUpdate: 'Download this update now?',
    download: 'Download',
    later: 'Later',
    updateCheckFailedTitle: 'Unable to Check for Updates',
    updateCheckFailedMessage: 'Aera Code could not check for updates.',
    tryAgainLater: 'Please try again later.',
    upToDateTitle: 'Aera Code Is Up to Date',
    upToDateMessage: 'No newer version of Aera Code is available.',
    installedVersion: version => `Installed version: ${version}`,
    installerUnavailable: 'Installer downloads are unavailable in this build.',
    updateDownloadedTitle: 'Aera Code Update Downloaded',
    updateReady: version => `Aera Code ${version} is ready to install.`,
    macInstallInstructions: 'The disk image has opened. Replace Aera Code in Applications, then reopen it.',
    windowsInstallQuestion: 'Restart Aera Code and run the installer now?',
    ...
    updateInstalled: version => `Aera Code ${version} has been installed.`,
    ...
    terminalErrorTitle: 'Unable to Open Aera Code Terminal',
    terminalErrorMessage: 'Aera Code could not open a terminal.',
    diagnosticsErrorTitle: 'Unable to Export Diagnostics',
    diagnosticsErrorMessage: 'Aera Code could not export the diagnostic archive.',
  ...
  zh: {
    ...
    pluginRecoveryInstructions: '请打开 Aera Code 终端更新或移除失败的第三方插件，然后重启 Aera Code。',
    openTerminal: '打开 Aera Code 终端',
    restart: '重启 Aera Code',
    dismiss: '关闭',
    updateAvailableTitle: 'Aera Code 有可用更新',
    updateAvailableMessage: version => `Aera Code ${version} 已可用。`,
    downloadUpdate: '现在下载此更新？',
    download: '下载',
    later: '稍后',
    updateCheckFailedTitle: '无法检查更新',
    updateCheckFailedMessage: 'Aera Code 无法检查更新。',
    tryAgainLater: '请稍后重试。',
    upToDateTitle: 'Aera Code 已是最新版本',
    upToDateMessage: '当前没有更新版本的 Aera Code。',
    installedVersion: version => `当前版本：${version}`,
    installerUnavailable: '此构建不支持下载安装包。',
    updateDownloadedTitle: 'Aera Code 更新已下载',
    updateReady: version => `Aera Code ${version} 已可安装。`,
    macInstallInstructions: '磁盘映像已打开。请替换“应用程序”中的 Aera Code，然后重新打开。',
    windowsInstallQuestion: '现在重启 Aera Code 并运行安装程序？',
    ...
    updateInstalled: version => `Aera Code ${version} 已安装。`,
    removeInstallerQuestion: path => `是否删除下载的安装包以释放磁盘空间？\n\n${path}`,
    deleteInstaller: '删除安装包',
    keepInstaller: '保留安装包',
    terminalErrorTitle: '无法打开 Aera Code 终端',
    terminalErrorMessage: 'Aera Code 无法打开终端。',
    diagnosticsErrorTitle: '无法导出诊断信息',
    diagnosticsErrorMessage: 'Aera Code 无法导出诊断包。',
