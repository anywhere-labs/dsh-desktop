...
const COPY: Record<DesktopLocale, DesktopSetupWizardCopy> = {
  en: {
    beta: 'Beta',
    title: 'Set up Aera Code',
    profile: 'Profile',
    welcomeTitle: 'Welcome to Aera Code',
    ...
    presentationBody: 'Choose how Aera Code presents the official client.',
    ...
    communityMarketBody: 'The open market built into Aera Code, including custom data sources.',
    ...
    successBody: 'Aera Code is ready for this Profile.',
    startUsing: 'Start using Aera Code',
  ...
  zh: {
    ...
    lanWarningBody: '这样很危险，所有在你局域网内的人都能直接操作你的电脑，请谨慎开启。由于浏览器安全限制，从局域网内使用 HTTP 访问时，部分安全模块可能不可用，可能导致 Aera Code 无法正常使用。',
    ...
    communityMarket: 'dsh-community-market',
    communityMarketBody: 'Aera Code 内置的开放市场，并支持自定义数据源。',
    dshMarket: 'dsh-market',
    ...
    confirmSkip: '确认跳过',
    successTitle: '设置成功',
    successBody: '这个 Profile 的 Aera Code 已准备就绪。',
    startUsing: '开始使用',
