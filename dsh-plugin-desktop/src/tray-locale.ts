...
const labels: Record<DesktopLocale, Record<DesktopTrayLabelKey, (value: string) => string>> = {
  en: {
    ...
    downloadingUpdate: version => `Downloading Aera Code ${version}…`,
    ...
    updateAvailable: version => `Aera Code ${version} Available`,
  },
  zh: {
    addProfile: () => '新建 Profile…',
    checkForUpdates: () => '检查更新…',
    checkingForUpdates: () => '正在检查更新…',
    downloadingUpdate: version => `正在下载 Aera Code ${version}…`,
    ...
    updateAvailable: version => `Aera Code ${version} 可用`,
  },
}
...
const restartConfirmationCopy: Record<DesktopLocale, Record<'normal' | 'recovery', DesktopRestartConfirmationCopy>> = {
  en: {
    normal: {
      title: 'Restart Aera Code',
      message: 'Restart Aera Code now?',
    ...
    recovery: {
      ...
      message: 'Restart Aera Code in Recovery Mode?',
