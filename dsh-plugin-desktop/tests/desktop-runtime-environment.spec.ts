...
function options(
  ...
  return {
    ...
    appExecutable: platform === 'win32'
      ? 'C:\\Program Files\\DSH 100% Desktop\\Aera Code.exe'
      : "/Applications/DSH O'Brien.app/Contents/MacOS/Aera Code",
    pnpmBinPath: platform === 'win32'
      ? 'C:\\Program Files\\Aera Code\\resources\\app.asar.unpacked\\node_modules\\pnpm\\bin\\pnpm.mjs'
