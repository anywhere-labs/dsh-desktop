...
const adaptation: WindowsAclAdaptation = {
  platform: 'win32',
  electron: true,
  execPath: 'C:\\Program Files\\Aera Code\\Aera Code.exe',
  upstreamRunner: 'C:\\Program Files\\Aera Code\\resources\\app.asar\\runner.js',
  trampoline: 'C:\\Program Files\\Aera Code\\resources\\app.asar\\desktop-runner.js',
}
